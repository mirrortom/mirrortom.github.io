...
<div id="mainmenubox" class="mainmenu grids-1 grids-md-3 text-center">
  ...
  <div class="mainmenu-theme text-right" id="themebox">
    ...
    <a fontval="14" title="fontSize 14px"><i class="i-ac-font text-sm"></i></a>
    <a fontval="16" title="fontSize 16px"><i class="i-ac-font text-md"></i></a>
    <a fontval="20" title="fontSize 20px"><i class="i-ac-font text-lg"></i></a>
