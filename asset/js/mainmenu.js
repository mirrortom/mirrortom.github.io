...
<div id="mainmenubox" class="mainmenu grids-1 grids-md-3 text-center">
  ...
  <div class="mainmenu-menu grids-3">
    <a class="mainmenu-link grid" href="/index.html"><h5>Home</h5></a>
    <a class="mainmenu-link grid" href="/projectinfo.html"><h5>Info</h5></a>
    <a class="mainmenu-link grid" href="/about.html"><h5>About</h5></a>
  </div>
  <div class="mainmenu-theme" id="themebox">
    <a fontval="14" title="font 14px"><i class="i-ac-font text-sm"></i></a>
    <a fontval="16" title="font 16px"><i class="i-ac-font text-md"></i></a>
    <a fontval="20" title="font 20px"><i class="i-ac-font text-lg"></i></a>
    <a colorval="1" title="亮light"><i class="i-a-sun"></i></a>
    <a colorval="2" title="暗dark"><i class="i-moon"></i></a>
    <div style="position:fixed;right:20px;bottom:20px;display:inline-flex;flex-direction: column;align-items: center;">
        <a href="/index.html" title="首页. to Home."><i class="i-a-home text-xxxl"></i></a>
        <a class="pd-t-15" href="javascript:scrollTo(0,0)" title="回到顶部. to page top."><i class="i-a-anglearr up text-xxxl"></i></a>
    </div>
  </div>
